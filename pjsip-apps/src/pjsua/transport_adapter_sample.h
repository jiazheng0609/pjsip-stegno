 ...
 */
#ifndef __PJMEDIA_TRANSPORT_ADAPTER_STEGNO_H__
#define __PJMEDIA_TRANSPORT_ADAPTER_STEGNO_H__
 ...
 */
PJ_DECL(pj_status_t) pjmedia_tp_stegno_create( pjmedia_endpt *endpt,
                                                const char *name,
